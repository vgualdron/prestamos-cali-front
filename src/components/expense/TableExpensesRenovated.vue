    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          label: 'Cuenta',
          field: (row) => row,
          format: (row) => `${row.account_type}: ${row.account_number}`,
          sortable: true,
          visible: true,
        },
        {
          name: 'account_type_third',
          align: 'left',
          label: 'Cuenta tercero',
          field: (row) => row,
          format: (row) => `${row.account_type_third ? row.account_type_third : ''}: ${row.account_number_third ? row.account_number_third : ''}`,
          sortable: true,
          visible: true,
        },
        {
