...
import redcollectorApi from '../../../api/redcollector/redcollectorApi';

export default {
  async [types.actions.SAVE_REDCOLLECTOR]({ commit }, payload) {
    try {
      const response = await redcollectorApi.save(payload);
